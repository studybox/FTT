...
from models.fjmp.modules.lanegcn_modules import *
...
class FJMPTrajectoryProposalDecoder(nn.Module):
    ...
    def forward(self, graph, actor_ctrs):
        ...
        proposals = proposals_coordinate_embedding.transpose(1, 2)
...
class FJMPAttentionTrajectoryDecoder(nn.Module):
    ...
    # def forward(self, graph, lane_graph, prop_ground_truth=0., batch_idcs=None):
