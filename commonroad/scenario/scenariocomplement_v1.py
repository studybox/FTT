...
class CoreFeatureExtractor0:
    def __init__(self, config):
        ...
        self.num_features = 3+6*self.horizon_len+4*self.prediction_len
        ...
        self.feature_info = { "egoid":{"high":3000, "low":0},
                              ...
                              "lane_lefts":{"high":1, "low":0},
                              "lane_rights":{"high":1, "low":0},
        ...
        self.feature_index = {"egoid":0,
                              ...
                              "obs_rel_xs":[1+2*self.horizon_len+i for i in range(self.horizon_len)],
                              "obs_rel_ys":[1+3*self.horizon_len+i for i in range(self.horizon_len)],
                              "lane_lefts":[1+4*self.horizon_len+i for i in range(self.horizon_len)],
                              "lane_rights":[1+5*self.horizon_len+i for i in range(self.horizon_len)],
                              ...
                              "fut_rel_xs":[3+6*self.horizon_len+2*self.prediction_len+i for i in range(self.prediction_len)],
                              "fut_rel_ys":[3+6*self.horizon_len+3*self.prediction_len+i for i in range(self.prediction_len)]
                              }
    ...
    def get_features(self, cr_scenario, vehicle_id, startframe):
        ...
        for t in range(self.horizon_len):
            ...
            self.features[self.feature_index["obs_rel_ys"][t]] = self.get_xy(cr_scenario, vehicle_id, startframe-(self.horizon_len-1-t)*self.delta_step, self.delta_step)
